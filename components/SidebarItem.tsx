...
const SidebarItem = ({
  ...
  return (
    <div
      onClick={handleClick}
      className={`relative flex flex-row justify-start items-center gap-4 text-xl mx-2 px-4 py-2 hover:bg-primary/10 rounded-full md:rounded-md md:object-fit hover:cursor-pointer ${
